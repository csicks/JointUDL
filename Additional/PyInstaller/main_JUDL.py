...
if __name__ == '__main__':
    ...
    parser.add_argument('--log', type=str, help='name of log file', default='judl_log.txt')
...
For python file: python main_JUDL.py --path /path/to/data --ref /path/to/reference --model /path/to/model --out /path/to/output
For binary file: ./main_JUDL --path /path/to/data --ref /path/to/reference --model /path/to/model --out /path/to/output
'''