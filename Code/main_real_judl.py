...
class AutoEncoder(nn.Module):
    ...
    def __init__(self, ):
        ...
        self.encoder = nn.Sequential(nn.Conv2d(1, 2, kernel_size=3, padding=1, bias=False),
                                     nn.BatchNorm2d(2), nn.ReLU(inplace=True), nn.MaxPool2d(2),
                                     nn.Conv2d(2, 4, kernel_size=3, padding=1, bias=False),
                                     nn.BatchNorm2d(4), nn.ReLU(inplace=True), nn.MaxPool2d(2),
                                     nn.Conv2d(4, 8, kernel_size=3, padding=1, bias=False),
                                     nn.BatchNorm2d(8), nn.ReLU(inplace=True), nn.MaxPool2d(2))
...
def main_synthetic(logger, name, continue_flag=False):
    ...
    for epoch in range(current_epoch + 1, 10000 + current_epoch):
