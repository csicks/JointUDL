...
def joint_one(path, folder, batch, norm=False, shuffle=True):
    '''
    Get synthetic cryo-EM dataset in Fourier domain for images in one folder. For JUDL.
    ...
    dataset_train = JointOne(data_train, norm)
