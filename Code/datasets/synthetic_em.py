...
def us_synthetic_fourier(path, batch, fc, fn, picked=None, norm=False, shuffle=True):
    '''
    ...
    train_loader = synthetic_base(data_all, SyntheticFourier, batch, norm=norm, shuffle=shuffle)
    return train_loader
