...
def us_joint_fourier(path, batch, fc, fn, picked=None, norm=False, shuffle=True):
    '''
    ...
    train_loader = joint_base(data_all, JointFourier, batch, norm=norm, shuffle=shuffle)
    return train_loader
